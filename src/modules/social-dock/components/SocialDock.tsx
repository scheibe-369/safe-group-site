...
import { socialDockCopy, socialNetworks } from "../data/networks";
...
export function SocialDock() {
  ...
  return (
    <>
      ...
      >
        <ul id="safe-social-dock" aria-label={socialDockCopy.listLabel} aria-hidden={!open} inert={!open} className="flex flex-col items-end gap-3">
        ...
        <button
          ...
          aria-label={open ? socialDockCopy.close : socialDockCopy.open}
