  ...
  return (
    <section className="relative overflow-hidden border-t border-white/10 bg-black py-24 sm:py-32">
      ...
      <div className="safe-container text-center">
        ...
        <h2 className="mx-auto mt-5 max-w-4xl text-4xl font-semibold leading-[.98] tracking-[-.05em] sm:text-6xl">Antes de escolher a ferramenta, descubra a alavanca.</h2>
        <ButtonLink href="/contacto" className="mt-9">Solicitar diagnóstico</ButtonLink>
      </div>
    </section>
  );
}
