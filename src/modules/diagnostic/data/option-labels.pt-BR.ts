...
/**
 * Rotulos pt-BR das opcoes do formulario, traduzidos da baseline pt-PT.
 *
 ...
 */
export const diagnosticOptionLabelsPtBR: DiagnosticOptionLabels = {
  sector: {
  ...
  operationSize: {
    ...
    "2 a 4 unidades ou equipas": "2 a 4 unidades ou times",
    "5 ou mais unidades ou equipas": "5 ou mais unidades ou times",
  },
  priority: {
    "Gerar mais procura": "Gerar mais demanda",
