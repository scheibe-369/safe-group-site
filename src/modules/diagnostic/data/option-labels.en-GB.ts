 ...
 */
export const diagnosticOptionLabelsEnGB: DiagnosticOptionLabels = {
  sector: {
    "Automóvel": "Automotive",
    "Financeiro": "Financial",
    "Software ou SaaS": "Software or SaaS",
    "Outra operação high ticket": "Another high ticket business",
  },
  operationSize: {
  ...
  priority: {
    ...
    "Melhorar atendimento e conversão": "Improve handling and conversion",
    "Organizar CRM, dados e operação": "Organise CRM, data and operations",
    "Desenvolver software ou SaaS": "Develop software or SaaS",
    "Melhorar margem e eficiência": "Improve margin and efficiency",
    "Ainda não está claro": "Not yet clear",
  },
};
