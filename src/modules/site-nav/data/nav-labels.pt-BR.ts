...
/**
 * Copy do menu em pt-BR, traduzida da baseline pt-PT. So texto: os destinos
 * vivem em `nav-content.ts`, que junta cada `hash` ao endereco da Home no
 * idioma certo.
 */
export const siteNavLabelsPtBR: SiteNavLabels = {
