...
/**
 * Cases em pt-PT, a lingua de origem. Nem tudo neste ficheiro e traduzivel:
 ...
 */
export const caseStudiesPtPT: CaseStudy[] = [
  {
    slug: "growth-hub",
    client: "Growth Hub",
  ...
  },
  {
    ...
    sector: "Retalho Automóvel",
    summary: "Instagram sem força comercial e nenhuma frente para comprar veículos em condições competitivas, quando a rentabilidade do retalho automóvel começa antes da venda.",
    ...
    deliverables: [
      ...
      "Funis de vendas",
      "Campanhas para feiras e eventos internos",
      "Campanhas de aquisição de veículos com melhor margem",
    ],
    context: "A SAC Automóveis precisava reforçar a presença digital e transformar o Instagram numa frente comercial ativa. Mas o desafio não terminava na venda: no retalho automóvel, a rentabilidade também começa na compra do veículo e na qualidade do stock que entra na operação.",
    challenge: "Era preciso atuar nas duas pontas do negócio: gerar mais oportunidades de venda e criar campanhas capazes de atrair veículos para compra em condições mais competitivas. A estratégia precisava aumentar audiência e autoridade, apoiar as feiras internas e melhorar a capacidade da loja de comprar, definir preços e vender com mais margem.",
    intervention: "A Safe estruturou uma estratégia de marketing e vendas para ampliar a presença da SAC no Instagram, aumentar a base de seguidores e consolidar a autoridade da marca no mercado automóvel. Em paralelo, desenvolveu funis e campanhas para eventos internos, feiras e aquisição de veículos. A comunicação passou a trabalhar tanto a procura de quem quer comprar como a atração de oportunidades de stock com maior potencial de rentabilidade.",
    structure: "Uma operação de marketing ligada ao ciclo completo do negócio: autoridade → audiência → campanhas de compra → stock → campanhas de venda → feiras → margem. O Instagram deixou de ser apenas uma montra: passou a apoiar a entrada de veículos, a geração de procura e a rentabilidade por venda.",
    results: [
      "Crescimento da base de seguidores e reforço da autoridade da SAC Automóveis no Instagram.",
      "Campanhas estruturadas para gerar oportunidades de compra e venda de veículos, incluindo feiras e eventos internos.",
      "Marketing ligado à margem da operação: mais capacidade para comprar melhor, formar stock com mais potencial e vender com mais rentabilidade.",
    ],
    gallery: [],
  },
  {
    ...
    sector: "Retalho Automóvel",
    summary: "Loja de automóveis do interior a apostar em feirões periódicos, sem forma de qualificar o volume de leads do tráfego pago nem de reativar a base de contactos antigos.",
    ...
    challenge: "O volume de leads gerado pelas campanhas e pelos disparos para a base antiga era grande demais para um atendimento manual. Sem pré-qualificação, os vendedores perdiam tempo com leads sem intenção real de compra, e a base antiga de contactos ficava esquecida entre um feirão e outro.",
    intervention: "A Safe assumiu a gestão de campanhas de tráfego pago focadas nos feirões, com produção própria de criativos, e estruturou uma estratégia de disparo de mensagens para reativar a base de leads antigos da loja. Para dar conta do volume, desenvolveu dois agentes de IA: um de pré-atendimento, que qualificava todos os leads de tráfego pago antes de os repassar aos vendedores, descartando os sem qualificação, e outro dedicado a abordar os leads dos disparos e conduzi-los até à venda.",
    structure: "Duas frentes ligadas ao mesmo objetivo: tráfego pago e criativos a alimentar os feirões, com um agente de IA a filtrar o que chegava aos vendedores, e disparos para a base antiga trabalhados por um segundo agente de IA até à conversão. Os vendedores só recebiam leads já qualificados.",
    results: [
      "Mais de 50 carros vendidos num único feirão.",
