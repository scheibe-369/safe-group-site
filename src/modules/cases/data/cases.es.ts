...
export const caseStudiesEs: CaseStudy[] = [
  ...
  },
  {
    ...
    sector: "Comercio Automotor",
    summary: "Tienda de automóviles del interior apostando por ferias periódicas, sin forma de cualificar el volumen de leads del tráfico pago ni de reactivar la base de contactos antiguos.",
    cover: "/cases/new-car-automoveis.webp",
    area: "Tráfico pago, automatización de atención y gestión de ferias",
    deliverables: [
      "Gestión de campañas de tráfico pago para ferias",
      "Producción de creativos",
      "Envío de mensajes a la base de leads antiguos",
      "Agente de IA de precualificación de leads",
      "Agente de IA de conversión para ventas",
    ],
    context: "New Car Automóveis es una tienda de automóviles del interior que apostaba por ferias periódicas para vender, pero generaba tráfico pago sin conseguir filtrar qué leads valían el tiempo de los vendedores ni reactivar la base de leads antiguos detenida en el CRM.",
    challenge: "El volumen de leads generado por las campañas y por los envíos a la base antigua era demasiado grande para una atención manual. Sin precualificación, los vendedores perdían tiempo con leads sin intención real de compra, y la base antigua de contactos quedaba olvidada entre una feria y otra.",
    intervention: "Safe asumió la gestión de campañas de tráfico pago centradas en las ferias, con producción propia de creativos, y estructuró una estrategia de envío de mensajes para reactivar la base de leads antiguos de la tienda. Para hacer frente al volumen, desarrolló dos agentes de IA: uno de preatención, que cualificaba todos los leads de tráfico pago antes de pasarlos a los vendedores, descartando los que no tenían cualificación, y otro dedicado a abordar los leads de los envíos y conducirlos hasta la venta.",
    structure: "Dos frentes conectados al mismo objetivo: tráfico pago y creativos alimentando las ferias, con un agente de IA filtrando lo que llegaba a los vendedores, y envíos a la base antigua trabajados por un segundo agente de IA hasta la conversión. Los vendedores solo recibían leads ya cualificados.",
    results: [
      "Más de 50 vehículos vendidos en una sola feria.",
      "Todos los leads de tráfico pago precualificados por IA antes de llegar a los vendedores, con los no cualificados descartados.",
      "Reactivación de la base de leads antiguos con un agente de IA dedicado a convertir los envíos en ventas.",
    ],
    gallery: [],
  },
];
