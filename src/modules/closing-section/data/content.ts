...
export const closingSectionContent: ClosingSectionContent = {
  ...
  descA: "Partilhe o contexto da operação. A primeira conversa serve para perceber onde existe ",
  descStrong: "maior potencial de crescimento, lucro ou eficiência",
  descB: ", antes de decidir qualquer estrutura.",
  benefits: [
    "A leitura da operação vem antes da ferramenta",
    "Uma estrutura desenhada para uma oportunidade concreta",
    "Frentes que avançam isoladamente ou em conjunto",
    "Ordem, responsáveis, tecnologia e métricas definidos no diagnóstico",
  ],
