...
- The Growth Hub relationship may appear as a real, evidenced case in `/cases` (approved 27/08/2026), in Safe's structural voice (context, challenge, intervention, structure, verified results), never as agency/marketing-service language. Outside that one case entry, keep the relationship out of commercial copy.
...
- No footer production credit: removed 29/08/2026 by explicit client instruction. Do not re-add it.
